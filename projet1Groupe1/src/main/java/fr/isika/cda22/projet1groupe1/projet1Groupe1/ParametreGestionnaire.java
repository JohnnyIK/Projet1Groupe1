...
public interface ParametreGestionnaire {
	...
	public final static int TAILLE_NOEUD_OCTET = TAILLE_STAGIAIRE_OCTET + 4 + 4 + 4; // 136
	
	public final static int INDEX_FILS_GAUCHE_OCTET = TAILLE_STAGIAIRE_OCTET ;
	public final static int INDEX_FILS_DROIT_OCTET = TAILLE_STAGIAIRE_OCTET + 4;
	public final static int INDEX_DOUBLON_OCTET = TAILLE_STAGIAIRE_OCTET + 4 + 4; 
	
	public final static String CHEMIN_BIN = "src/main/java/Fichier/sauvegardeAnnuaire.bin";
	public final static String CHEMIN_TXT = "src/main/java/Fichier/STAGIAIRES_10.DON";
